...
/**
 * Tests de la normalisation des couleurs des visuels réseaux sociaux
 * (primaire, secondaire, fond).
 */
final class CouleursSocialTest extends TestCase
{
    public function test_should_keep_colors_when_valid_hex(): void
    {
        $couleurs = monclubtt_normaliser_couleurs_social(array(
            'primaire'   => '#0F6E4C',
            'secondaire' => '#c8103e',
            'fond'       => '#f4f1ea',
        ));
    ...
    {
        $defaut   = MonClubTT_Constantes::COULEURS_SOCIAL_DEFAUT;
        $couleurs = monclubtt_normaliser_couleurs_social(array(
            'primaire'   => 'red',
    ...
    {
        $this->assertSame(MonClubTT_Constantes::COULEURS_SOCIAL_DEFAUT, monclubtt_normaliser_couleurs_social(false));
    }

    public function test_should_ignore_unknown_keys_when_normalizing(): void
    {
        $couleurs = monclubtt_normaliser_couleurs_social(array('primaire' => '#112233', 'autre' => '#445566'));
