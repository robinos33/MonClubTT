...
* Added: "Players' jersey" colour in the club colours, applied to the podium players
...
* Added: Top performances image shows the round number ("J1") and a weekend summary (performances, players, points earned)
* Changed: new image layout — circled logo and club name, bold headline, date pill with a rule, tinted rows with a rank square, footer rule with the club name
...
* Added: "Top Progression" image (month or season, All / Men / Women filter) based on the widget podium, with the players' cut-out photos
* Added: "Top performances" image for the last team championship weekend: wins against higher-ranked opponents read from the match sheets, grouped by player, with points earned per the FFTT scale
